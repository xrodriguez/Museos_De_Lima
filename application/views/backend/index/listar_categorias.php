...
<div class="row-fluid">
	<div class="span12">
            <div class="buttons" style="float:right;">
                ...
                <a class="btn btn-success btn-mini" href="<?php echo base_url()?>backend/index/add_categoria"  id="add-event">
        ...
        <div class="widget-box">
            <div class="widget-title">
                <h5>Listado de Categorias de Museos</h5>
            </div>
            ...
            <?php } ?> 
                ...
                <table class="table table-bordered data-table">
                    ...
                    foreach($datos as $rowdato)
                    {
                        ...
                        $id =$rowdato->id_categ;
                        //$row_ciudad= $this->super_model->buscarcategoria_xid($id);
                        $categoria = $rowdato->nombre;
                     ...
                     ?>
                        <tr class="gradeX">
                            ...
                            <td  style="color:#ffa500;"><?php echo $i; ?></td>
                             ...
                             <td> <!-- TD de Accion-->
                    <a href="<?php echo base_url()?>backend/index/edit_categorias/<?php echo $id ?>"><?php echo $ico_editar; ?></a> 
                                 |
                              ...
                              <form  action="" name="basic_validate" id="basic_validate  B<?php echo $id; ?>" method="post" >
                                ...
                                <input type="hidden" name="id_categ" value="<?php echo $id; ?>" />   
