...
<div class="row-fluid">
	<div class="span12">
            <div class="buttons" style="float:right;">
                ...
                <a class="btn btn-success btn-mini" href="<?php echo base_url()?>backend/index/add_museo"  id="add-event">
            ...
            <?php } ?> 
                ...
                <table class="table table-bordered data-table">
                    ...
                    foreach($datos as $rowdato)
                    {
                        ...
                        $id =$rowdato->id;
                        $id_categ=$rowdato->id_categ;
                        $row_ciudad= $this->super_model->buscarciudad_xid($id_categ);
                        $categoria = $row_ciudad[0]->nombre;
                        $nombre=$rowdato->Nombre;
                        $horario=$rowdato->Horario;
                        
                        $estado=$rowdato->estado;
                     ?>
                        <tr class="gradeX">
                           
                            <td  style="color:#ffa500;"><?php echo $i; ?></td>
                             <td style="text-align:left !important; padding-left: 5px;"><?php echo $categoria; ?></td>
                             <td style="text-align:left !important; padding-left: 5px;"><?php echo $nombre; ?></td>
                             <td style="text-align:left !important; padding-left: 5px;"><?php echo $horario ?></td>
                             <td>
                             ...
                             <td> <!-- TD de Accion-->
                    <a href="<?php echo base_url()?>backend/index/edit_museo/<?php echo $id ?>"><?php echo $ico_editar; ?></a> 
                                 |
