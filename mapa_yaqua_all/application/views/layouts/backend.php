		...
		<div id="sidebar">
			...
			<ul>
				<li <?php if($this->uri->segment(3)=="backend") echo ' class="active"' ?>>
                                ...
                                <li class="submenu <?php if($this->uri->segment(3)=="listar_distritos" 
                                       or $this->uri->segment(3)=="edit_distritos" 
                                        ) echo 'open' ?>">
                                    ...
                                    <ul>
                                        ...
                                        <li <?php if($this->uri->segment(3)=="listar_distritos" or $this->uri->segment(3)=="edit_multa") echo ' class="active"' ?>>
                                            <a href="<?php echo site_url(); ?>backend/index/listar_distritos">Distritos</a>
                                        </li>
                                    </ul>
				</li>
